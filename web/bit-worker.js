...
class Bit:
    ...
    def _compare(self, other):
        ...
        if any(self.world[r][c] != other.world[r][c] for r in range(self.n_rows) for c in range(self.n_cols)):
            raise BitComparisonException("Bit world does not match expected world", [other.world, list(other.pos), other.orientation])
        if self.pos != other.pos:
            raise BitComparisonException(f"Location of Bit does not match: {self.pos} vs {other.pos}", [other.world, list(other.pos), other.orientation])
